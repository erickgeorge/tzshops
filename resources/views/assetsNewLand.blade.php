...
<div class="container"><br>
    <div class="row container-fluid" >
        <div class="col">
            <h5 ><b style="text-transform: capitalize;">Add New Land Asset</b></h5>
        </div>
    </div>
    <hr class="container">
    <div class="container">
        ...
        <form action="{{route('assetsNewLandSave')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="card">
                <div class="card-body">
                    <div class="card-text">
                           ...
                           <div class="row">
                            ...
                            <div class="row">
                                   <input id="quantity"  hidden required min="1" class="form-control" type="number" name="Quantity">
...
&nbsp;
                    <a href="{{route('assetsLand')}}" id="newcard" class=" btn btn-danger text-light" name="newcard">Cancel</a>
