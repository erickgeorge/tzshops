                        ...
                        <tr>
                          ...
                          <td> <div class="row"><a style="color: green;" data-toggle="modal" data-target="#modal-sm{{$i}}"  title="Edit issue"><i
                                                    class="fas fa-edit"></i></a>
                                                      &nbsp;  
                                    <form method="POST"
                                          onsubmit="return confirm('Are you sure you want to delete this?')" action="{{ route('deletevoucher', [$vc->id]) }}" >
                                        {{csrf_field()}}
                                        <button type="submit"
                              ...
                              <div class="modal-dialog modal-sm">
                                <div class="modal-content">
                                  <div class="modal-header">
                                   ...
                                   <?php $isssueid = Crypt::encrypt($vc->id); ?> 
                                  <form method="POST" action="{{route('editvoucher',[$isssueid])}}">
                                    @csrf
                                  <div class="modal-body">
                                 
                                     <input required="" class="form-control form-control-lg" type="date" placeholder="Used  issue" name="date" value="{{$vc->date}}">
                                      <br>
                                     <input required="" class="form-control form-control-lg" type="number" placeholder="Price" min="0" name="price" value="{{$vc->price}}">
                                      <br>
                                     <input required="" class="form-control form-control-lg" type="number" placeholder="Value" min="0" name="value" value="{{$vc->value}}">
                                      <br>
