...
@section('body')
  ...
  <div class="container">
                ...
                <form method="POST" action="{{ route('updatevoucheradd',[$id]) }}" class="col-lg-12">
                    @csrf
   ...
   <div >
    ...
    <TABLE id="dataTable" >
        <TR>
            ...
            <TD><input  oninput="totalitem()" id="istock"  min="1"  class="form-control" type="number" name="value[]" placeholder="Value.." oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"  required="required"   >    </TD>
