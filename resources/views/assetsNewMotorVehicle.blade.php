...
<div class="container"><br>
    <div class="row container-fluid" >
        <div class="col">
            <h5><b style="text-transform: capitalize;">Add New Motor Vehicle Asset</b></h5>
        </div>
    </div>
    <hr class="container">
    <div class="container">
        ...
        <form action="{{route('assetsNewMotorVehicleSave')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="card">
                <div class="card-body">
                    <div class="card-text">
                        ...
                        <div class="row">
                            <div class="form-group col">
                                ...
                                <input id="quantity" hidden required min="1" class="form-control" value="1" type="number" name="Quantity">
