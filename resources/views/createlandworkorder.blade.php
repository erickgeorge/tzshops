...
@section('body')
    ...
    <div class="row" style=" margin-left:2%; margin-right:2%;">
        <div class="col-md-8">
            <h5 style="padding-left: 90px;  text-transform: uppercase;" >Create new works order for landscaping</h5>
        </div>
    </div>
    <hr>
    @if ($errors->any())
...
<div class="container">
    ...
    <form method="POST" action="{{ route('wo.create.landscaping') }}"  style="margin-left:2%; margin-right:2%;">
        @csrf
        <div class="row">
            <div class="col">
                <div class="input-group mb-3">
            <div class="input-group-prepend">
                <label style="height: 28px" class="input-group-text" for="inputGroupSelect01">maintenance section</label>
            </div>
 ...
 @foreach($sectionss as $sectionss) 
     ...
     <br>
      ...
      <br>
        ...
        <a class="btn btn-danger" href="/Land/work_order" role="button">Cancel</a>
</div>
        </div>
    </form>
