...
<div class="container"><br>
    <div class="row container-fluid" >
        <div class="col-md-6">
            <h5 style="padding-left: 90px;"><b style="text-transform: uppercase;">Land Asset</b></h5>
        </div>
    </div>
    <hr class="container">
    <div class="container">
    ...
    @if (count($land)>0)
        <div class="card">
            @foreach ($land as $landinfo)
                ...
                <div class="card-footer text-right">
                    ...
                    @endif
                    @endif
                     <a href="{{route('assetinfo/export/',[$landinfo->id,'land'])}}" class="btn btn-primary" type="button">Export <i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>
                     @if (($role['user_role']['role_id'] != 1)||(auth()->user()->type !='Assets Officer'))
                     @else
        ...
        <div class="container">
            ...
            <div class="row text-right">
                <div class="col">
                    <a href="{{route('asset/assesment/export/',[$type])}}?type=land" class="btn btn-primary" id="btnExport" > Export <i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>
                </div>
            </div><br>
