...
<div class="container"><br>
    <div class="row container-fluid" >
        <div class="col-md-6">
            <h5><b style="text-transform: capitalize;">Land Asset</b></h5>
        </div>
    </div>
    <hr class="container">
    <div class="container">
    ...
    @if (count($land)>0)
        <div class="card">
            @foreach ($land as $landinfo)
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col text-right">
                            <a target="_blank"  href="{{route('assetinfo/export/',[$landinfo->id,'land'])}}" class="btn btn-primary" type="button">Export <i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>
                ...
                <div class="card-footer text-right">
                    ...
                    @endif
                    <a href="{{route('assetsLandEdit',[$landinfo->id])}}" class="btn btn-primary" type="button"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</a>
                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog " role="document">
                    <div class="modal-content">
                      ...
                      <form enctype="multipart/form-data" action="{{route('assetsAssesLandSave')}}" method="post">
                          @csrf
        ...
        <div class="container">
            ...
            <div class="row text-right">
                <div class="col">
                    <a href="{{route('asset/assesment/export/',[$type])}}?type=land" class="btn btn-primary" id="btnExport"  target="_blank" > Export <i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>
                </div>
            </div><br>
