...
<div class="container"><br>
    <div class="row container-fluid" >
        <div class="col">
            <h5 style="padding-left: 90px;"><b style="text-transform: uppercase;">Add New Furniture Asset</b></h5>
        </div>
    </div>
    <hr class="container">
    <div class="container">
        ...
        <form action="{{route('assetsNewFurnitureSave')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="card">
                <div class="card-body">
                    <div class="card-text">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-2">
                    <a href="{{route('assetsFurniture')}}" id="newcard" class="form-control btn btn-danger text-light" name="newcard">Cancel</a>
                </div>
            </div>
        </form>
        <br>
