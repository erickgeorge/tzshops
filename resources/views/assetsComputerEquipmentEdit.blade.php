...
<div class="container"><br>
    <div class="row container-fluid" >
        <div class="col">
            <h5><b style="text-transform: capitalize;">Edit Computer Equipment Asset</b></h5>
        </div>
    </div>
    <hr class="container">
    <div class="container">
...
@foreach ($land as $item)
        <form action="{{route('assetsComputerEquipmentEditSave')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="card">
                <div class="card-body">
                    <div class="card-text">
                           ...
                           <div class="row">
                               ...
                               <div class="form-group col">
                                   ...
                                   <input id="location" value="{{$item->location}}" required class="form-control" placeholder="Block/Plot/Room" type="text" name="SiteLocation2">
                               </div>
                            </div>
                            <div class="row">
                               <div class="form-group col">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-2">
                    <a href="{{route('assetsComputerEquipmentView',[$item->id])}}" class="form-control btn btn-danger" name="newcard">Cancel</a>
                </div>
            </div>
        </form>
        @endforeach
