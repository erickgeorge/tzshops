...
<div class="container"><br>
    <div class="row container-fluid" >
        <div class="col">
            <h5 style="padding-left: 90px;"><b style="text-transform: uppercase;">Edit Motor vehicle Asset</b></h5>
        </div>
    </div>
    <hr class="container">
    <div class="container">
...
@foreach ($land as $item)
        <form action="{{route('assetsMotorVehicleEditSave')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="card">
                <div class="card-body">
                    <div class="card-text">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-2">
                    <a href="{{route('assetsMotorVehicleView',[$item->id])}}" class="form-control btn btn-danger" name="newcard">Cancel</a>
                </div>
            </div>
        </form>
        @endforeach
