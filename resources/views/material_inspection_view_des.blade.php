        ...
        <table class="table table-striped display" id="myTable"  style="width:100%">
            ...
            @foreach($mcitems as $item)
              ...
              @if($item->check_return == NULL)
                     <h5>Accept and send to Store Manager <span> <a style="color: green;" href="{{ route('store.materialacceptdes', [$item->work_order_id , $item->zone] ) }}"  data-toggle="tooltip" title="Send to store Manager"><i class="far fa-check-circle"></i></a>
                   </span>

                 &nbsp;&nbsp;&nbsp;&nbsp;  Reject all materials <span> <a style="color: black;" title="Reject all Materials" data-toggle="modal" data-toggle= "tooltip" data-target="#exampleModalu"><i class="fas fa-times-circle" style="color: red"></i></a>
                </span>
              ...
              @if($item->check_return != NULL)
               ...
               <h5 style="padding-left: 600px;"> Return to HoS with accepted and rejected Material <span > <a style="color: green;" href="{{ route('store.materialaccept.reject.des', [$item->work_order_id , $item->hos_id]) }}"  data-toggle="tooltip" title="Return to HoS"><i class="fas fa-times-circle" style="color: red"></i></a>
                   </span></h5>
                   @endif
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="POST"  action ="{{ route('store.materialreject.des', [$item->work_order_id , $item->hos_id]) }}"  >
                        @csrf
    ...
    <div class="modal fade" id="exampleModali" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Please provide reason as to why you want to reject this material requested by Head of Section.</p>
                   <form method="POST"   action="{{ route('material_onebyone_des',[$item->work_order_id ])}}" class="col-md-6">
                        @csrf
