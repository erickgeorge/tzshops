...
<div class="container"><br>
    <div class="row container-fluid" >
        <div class="col ">
            <h5 style="padding-left: 90px;"><b style="text-transform: uppercase;">Reallocate Work in Progress to Assets</b></h5>
        </div>
    </div>
    <hr class="container">
    <div class="container">
                                   ...
                                   <div class="row">
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="form-group col">
                                           ...
                                           <input id="endingdate" required value="{{$landinfo->assetEndingDepreciationDate}}"   min="<?php echo date('Y-m-d'); ?>" class="form-control" placeholder="Ending Depreciation Date" type="date" name="EndingDepreciationDate">
                                       </div>
                                   </div>
