                    ...
                    <?php $i++; ?>
                        ...
                        <tr>
                          ...
                          <td><div class="row"> <a style="color: green;" data-toggle="modal" data-target="#modal-sm{{$i}}"  title="Edit issue"><i
                                                  ...
                                                  &nbsp;  
                                    <form method="POST"
                                          onsubmit="return confirm('Are you sure you want to delete this?')" action="{{ route('deletesales', [$sl->id]) }}" >
                                        {{csrf_field()}}
                                        <button type="submit"
                            ...
                            <div class="modal fade" id="modal-sm{{$i}}">
                              <div class="modal-dialog modal-sm">
                                <div class="modal-content">
                                  ...
                                  <?php $isssueid = Crypt::encrypt($sl->id); ?> 
                                  <form method="POST" action="{{route('editsales',[$isssueid])}}">
                                    @csrf
                                  <div class="modal-body">
                                 
                                     <input required="" class="form-control form-control-lg" type="date" placeholder="Used  issue" name="date" value="{{$sl->date}}">
                                      <br>
                                     <input required="" class="form-control form-control-lg" type="number" placeholder="Price" min="0" name="price" value="{{$sl->price}}">
                                      <br>
