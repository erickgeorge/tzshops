...
@endforeach
<h5 style="text-transform: uppercase;"><B>SCORES FOR {{$company->month}}'{{$company['companyname']['compantwo']->company_name}}' ON {{ date('F Y', strtotime($company->assessment_month))}}</B></h5>
<hr>
