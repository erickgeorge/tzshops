...
<div class="container"><br>
    <div class="row container-fluid" >
        <div class="col-md-6">
            <h5 style="padding-left: 90px;"><b style="text-transform: uppercase;">Plant and Machinery Assets</b></h5>
        </div>
    </div>
    <hr class="container">
    <div class="container">
            ...
            <form class="col-md-8" action="assetsSummaryFiltered" method="get">
                <div class="row">
                  ...
                  <select name="filter" id="my-select" class="form-control" name="">
                      ...
                      @php
                          $dates = assetsassesplantandmachinery::select('assesmentYear')->distinct()->orderBy('assesmentyear','Desc')->get();
                      @endphp
