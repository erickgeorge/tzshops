...
<div class="container"><br>
    <div class="row container-fluid" >
        <div class="col-md-6">
            <h5 ><b style="text-transform: capitalize;">Intangible Assets</b></h5>
        </div>
    </div>
    <hr class="container">
    <div class="container">
...
<div class="container">
                            ...
                            @endphp
                                ...
                                <td>
                                    @if (count($intangible6)>0)
                                        {{count($intangible6)}}
                                        &nbsp;<a  title="View Details"  href="{{route('assetExcel/export/')}}?type=Excel&asset=intangible&assetNumber=&AssetLocation=&cost=&condition=Obsolete&DateofAcquisition=&assetDateinUse=&EndingDepreciationDate=&Quantity="> <i class="fa fa-angle-double-right" aria-hidden="true"></i> </a>
                                    @else
                                        {{count($intangible6)}}
                                @endif
                                </td>
    ...
    <div class="row">
        ...
        <div class="col-md-2 text-right">
                ...
                <a href='{{route('assessingroup')}}?asset=intangible' class="btn btn-primary" title="assess all furniture assets"> Assess </a>
                    ...
                    <p>
                      ...
                      <div class="collapse" id="collapseExample">
                        <div class="card card-body">
                            <input type="text" hidden name="asset" value="intangible">

                            <div class="form-group">
                                <label for="my-input">Asset Number</label>
                                <select class="form-control" name="assetNumber" id="">
                                    @php
    $assetNumber=assetsintangible::select('assetNumber')->distinct()->orderBy('assetNumber','ASC')->get();
                                    @endphp
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="AssetLocation" id="">
                                    @php
    $assetLocation=assetsintangible::select('assetLocation')->distinct()->orderBy('assetLocation','ASC')->get();
                                    @endphp
                                        <option value="" selected>Not filtered</option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="cost" id="">
                                    @php
    $Cost=assetsintangible::select('Cost')->distinct()->orderBy('Cost','ASC')->get();
                                    @endphp
                                        <option value="" selected>Not filtered</option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="condition" id="">
                                    @php
    $Condition=assetsintangible::select('_condition')->distinct()->orderBy('_condition','ASC')->get();
                                    @endphp
                                        <option value="" selected>Not filtered</option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="DateofAcquisition" id="">
                                   @php
    $assetAcquisitionDate=assetsintangible::select('assetAcquisitionDate')->distinct()->orderBy('assetAcquisitionDate','ASC')->get();
                                    @endphp
                                        <option value="" selected>Not filtered</option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="assetDateinUse" id="">
                                   @php
    $assetDateinUse=assetsintangible::select('assetDateinUse')->distinct()->orderBy('assetDateinUse','ASC')->get();
                                    @endphp
                                        <option value="" selected>Not filtered</option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="EndingDepreciationDate" id="">
                                   @php
    $assetEndingDepreciationDate=assetsintangible::select('assetEndingDepreciationDate')->distinct()->orderBy('assetEndingDepreciationDate','ASC')->get();
                                    @endphp
                                        <option value="" selected>Not filtered</option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="Quantity" id="">
                                   @php
    $assetsquantity=assetsintangible::select('assetQuantity')->distinct()->orderBy('assetQuantity','ASC')->get();
                                    @endphp
                                        <option value="" selected>Not filtered</option>
        ...
        <tbody>
            @foreach ($land as $landinfo)
                <tr>
                    ...
                    <td><a name="" id="" class="btn btn-primary" href="{{route('assetsIntangibleView',[$landinfo->id])}}" title="View More Details" role="button"> <i class='fa fa-eye'></i> </a></td>
                </tr>
                @php
                    $d++;
                @endphp
        ...
        <div class="row">
            ...
            <div class="form-group  col">
                <select  id="my-select" class="form-control" name="date">
                    ...
                    @php
                        $dates = assetsassesintangible::select(DB::raw('DAY(assesmentYear) as day'))->distinct()->orderBy('assesmentyear','Desc')->get();
                    @endphp
                ...
                <select  id="my-select" class="form-control" name="month">
                    ...
                    @php
                        $dates = assetsassesintangible::select(DB::raw('MONTH(assesmentYear) as month'))->distinct()->orderBy('assesmentyear','Desc')->get();
                    @endphp
                    @foreach ($dates as $dated)
                ...
                <select  id="my-select" class="form-control" name="year">
                    ...
                    @php
                        $dates = assetsassesintangible::select(DB::raw('YEAR(assesmentYear) as year'))->distinct()->orderBy('assesmentyear','Desc')->get();
                    @endphp
                    @foreach ($dates as $dated)
            ...
            <input name="asset" type="text" value="Intangible" hidden>
            <div class="col">
            ...
            <div class="col-md-3 text-right">
                <form action="{{route('assetreportfromsummary')}}" method="get" enctype="multipart/form-data">
                    @csrf
                    <input type="text" name="asset" value="Intangible" hidden>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    @php
                        ...
                        $asseted = assetsassesintangible::orderBy('assesmentYear','Desc') ->where('assetID',$asses->assetID)->first();
