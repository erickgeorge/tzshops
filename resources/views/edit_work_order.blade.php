                                ...
                                <TD>
                                    ...
                                    <select  required class="custom-select"   name="material[]" >
                                        ...
                                        @foreach($materials as $material)
                                            <option value="{{ $material->id }}">{{ ucwords(strtolower($material->name)).', Description:[ '.ucwords(strtolower($material->description)).' ], Value:[ '.ucwords(strtolower($material->brand)).' ], Type:[ '.ucwords(strtolower($material->type)).' ]' }}</option>
                                        @endforeach
                                    </select>
