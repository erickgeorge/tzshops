...
<div class="container"><br>
    <div class="row container-fluid" >
        <div class="col-md-6">
            <h5 style="padding-left: 90px;"><b style="text-transform: uppercase;"> MotorVehicle Asset</b></h5>
        </div>
    </div>
    <hr class="container">
    <div class="container">
...
<div class="container">
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog " role="document">
                <div class="modal-content">
                  ...
                  <form enctype="multipart/form-data" action="{{route('assetsAssesMotorVehicleSave')}}" method="post">
                      @csrf
    ...
    <div class="container">
        ...
        <div class="row text-right">
            <div class="col">
                <a href="{{route('asset/assesment/export/',[$type])}}?type=motorvehicle" class="btn btn-primary" id="btnExport" > Export </a>
            </div>
        </div><br>
