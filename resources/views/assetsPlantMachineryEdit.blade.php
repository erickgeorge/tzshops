...
@section('title')
Edit Plant And Machinery Asset
    @endSection
...
<div class="container"><br>
    <div class="row container-fluid" >
        <div class="col">
            <h5><b style="text-transform: capitalize;">Edit Plant And Machinery Asset</b></h5>
        </div>
    </div>
    <hr class="container">
    <div class="container">
...
@foreach ($land as $item)
        <form action="{{route('assetsPlantMachineryEditSave')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="card">
                <div class="card-body">
                    <div class="card-text">
