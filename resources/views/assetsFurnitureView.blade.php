...
<div class="container">
    ...
    <div class="card">
        @foreach ($land as $landinfo)
            ...
            <div class="card-footer text-right">
                ...
                @endif
                 <a href="{{route('assetinfo/export/',[$landinfo->id,'furniture'])}}" class="btn btn-primary" type="button"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Export</a>
    ...
    <div class="container">
        ...
        <div class="row text-right">
            <div class="col">
                <a href="{{route('asset/assesment/export/',[$type])}}?type=furniture" class="btn btn-primary" id="btnExport" > Export </a>
            </div>
        </div><br>
