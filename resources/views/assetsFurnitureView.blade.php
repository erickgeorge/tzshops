...
<div class="container"><br>
    <div class="row container-fluid" >
        <div class="col-md-6">
            <h5><b style="text-transform: capitalize;">Furniture Asset</b></h5>
        </div>
    </div>
    <hr class="container">
    <div class="container">
...
<div class="container">
            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col text-right">
                        <a href="{{route('assetinfo/export/',[$landinfo->id,'furniture'])}}"  target="_blank" class="btn btn-primary" type="button">Export <i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog " role="document">
                <div class="modal-content">
                  ...
                  <form enctype="multipart/form-data" action="{{route('assetsAssesFurnitureSave')}}" method="post">
                      @csrf
    ...
    <div class="container">
        ...
        <div class="row text-right">
            <div class="col">
                <a href="{{route('asset/assesment/export/',[$type])}}?type=furniture" class="btn btn-primary"  target="_blank" id="btnExport" > Export <i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>
            </div>
        </div><br>
