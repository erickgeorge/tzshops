...
@section('body')
    ...
    <div >
        <div class="container">
            <h5 style=" " ><b >List of Zones and Total Locations with Works Order  </b></h5>
        </div>
                ...
                <?php $i = 0; ?>
                 @foreach($workszones as $locations)
                        ...
                        <tr>
                            ...
                            <td>@if(count($locationtotal)  < 1)<a class="btn text-light btn-primary" title="Can not view works order with zero locations" >No works order</a> @else<a href="onprocessworkorders?zone={{ $locations->id }} " class="btn btn-primary">view works orders</a>@endif</td>
                        </tr>
                        @endforeach
                </tbody>
            </table>
