...
<div class="container">
    ...
    <div class="row container-fluid" >
        <div class="col-lg-12">
            <h5 style="padding-left: 90px;  text-transform: uppercase;" ><b style="text-transform: uppercase;">Room report - Block</b></h5>
        </div>
                ...
                @foreach($wo as $work)
                        ...
                        <tr>
                            <th scope="row">{{ $i }}</th>
                                ...
                                <td>
                                    {{ $work->total_room }}  </td>
                                    <td><form method="get" action="inroomreporwithrooms"><button class="btn btn-primary" name="room" value="{{ $work->block_id }}"><i class="fa fa-eye"></i> view</button></form></td>
