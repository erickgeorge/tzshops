...
@section('body')
    ...
    <form method="POST" action="{{ route('workorder.create') }}">
        ...
        <button type="submit" style="background-color:#2E77BB;border-color:#2E77BB;" class="btn btn-success">Create Workorder</button>

        <a class="btn btn-info" style="background-color:#F9B100;border-color:#F9B100;" href="/work_order" role="button">Cancel</a>
