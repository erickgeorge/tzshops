...
<div class="container"><br>
    <div class="row container-fluid" >
        <div class="col-md-6">
            <h5 style="padding-left: 90px;"><b style="text-transform: uppercase;">Intangible Asset</b></h5>
        </div>
    </div>
    <hr class="container">
    <div class="container">
...
<div class="container">
        ...
        @foreach ($land as $landinfo)
            ...
            <div class="card-footer text-right">
                <!-- Button trigger modal -->
                 ...
                 <a href="{{route('assetinfo/export/',[$landinfo->id,'intangible'])}}" class="btn btn-primary" type="button"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Export</a>
    ...
    <div class="container">
        ...
        <div class="row text-right">
            <div class="col">
                <a href="{{route('asset/assesment/export/',[$type])}}?type=intangible" class="btn btn-primary" id="btnExport" > Export </a>
            </div>
        </div><br>
