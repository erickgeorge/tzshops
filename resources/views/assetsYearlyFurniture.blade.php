...
@section('title')
Furniture Assets Yearly Assessment
@endSection
...
<div class="container"><br>
    <div class="row container-fluid" >
        <div class="col-md-8">
            <h5><b style="text-transform: capitalize;">Furniture Assets Yearly Assessment</b></h5>
        </div>
        <div class="col">
    ...
    <div class="row">
        ...
        <div class="col  text-right">
            <form action="{{route('yearlyexport')}}" method="get">
                ...
                <input type="text" value="Furniture" name="asset" hidden>
