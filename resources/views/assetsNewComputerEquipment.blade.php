...
<div class="container"><br>
    <div class="row container-fluid" >
        <div class="col">
            <h5 style="padding-left: 90px;"><b style="text-transform: uppercase;">Add New Computer Equipment Asset</b></h5>
        </div>
    </div>
    <hr class="container">
    <div class="container">
        ...
        <form action="{{route('assetsNewComputerEquipmentSave')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="card">
                <div class="card-body">
                    <div class="card-text">
                           ...
                           <div class="row">
                            ...
                            <div class="row">
                               <div class="form-group col">
                                   ...
                                   <input id="assetnumber" required class="form-control" placeholder="eg: *04*00051" type="text" name="AssetNumber">
                               </div>
                            <div class="form-group col">
            ...
            <div class="row">
                <div class="form-group col-md-3">
                    <a href="{{route('assetsComputerEquipment')}}" id="newcard" class="form-control btn btn-danger text-light" name="newcard">Cancel</a>
                </div>
