...
<div class="container"><br>
    <div class="row container-fluid" >
        <div class="col-md-6">
            <h5 ><b style="text-transform: capitalize;">Land Assets</b></h5>
        </div>
    </div>
...
<div class="container">
                    ...
                    <p>
                      ...
                      <div class="collapse" id="collapseExample">
                        <div class="card card-body">
                            <input type="text" hidden name="asset" value="land">

                            <div class="form-group">
                                <label for="my-input">Asset Number</label>
                                <select class="form-control" name="assetNumber" id="">
                                    @php
    $assetNumber=assetsland::select('assetNumber')->distinct()->orderBy('assetNumber','ASC')->get();
                                    @endphp
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="AssetLocation" id="">
                                    @php
    $assetLocation=assetsland::select('assetLocation')->distinct()->orderBy('assetLocation','ASC')->get();
                                    @endphp
                                        <option value="" selected>Not filtered</option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="cost" id="">
                                    @php
    $Cost=assetsland::select('Cost')->distinct()->orderBy('Cost','ASC')->get();
                                    @endphp
                                        <option value="" selected>Not filtered</option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="condition" id="">
                                    @php
    $Condition=assetsland::select('_condition')->distinct()->orderBy('_condition','ASC')->get();
                                    @endphp
                                        <option value="" selected>Not filtered</option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="DateofAcquisition" id="">
                                   @php
    $assetAcquisitionDate=assetsland::select('assetAcquisitionDate')->distinct()->orderBy('assetAcquisitionDate','ASC')->get();
                                    @endphp
                                        <option value="" selected>Not filtered</option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="assetDateinUse" id="">
                                   @php
    $assetDateinUse=assetsland::select('assetDateinUse')->distinct()->orderBy('assetDateinUse','ASC')->get();
                                    @endphp
                                        <option value="" selected>Not filtered</option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="EndingDepreciationDate" id="">
                                   @php
    $assetEndingDepreciationDate=assetsland::select('assetEndingDepreciationDate')->distinct()->orderBy('assetEndingDepreciationDate','ASC')->get();
                                    @endphp
                                        <option value="" selected>Not filtered</option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="Quantity" id="">
                                   @php
    $assetsquantity=assetsland::select('assetQuantity')->distinct()->orderBy('assetQuantity','ASC')->get();
                                    @endphp
                                        <option value="" selected>Not filtered</option>
        ...
        <tbody>
            @foreach ($land as $landinfo)
                <tr>
                    ...
                    <td><a name="" id="" class="btn btn-primary" href="{{route('assetsLandView',[$landinfo->id])}}" title="View More Details" role="button"> <i class='fa fa-eye'></i> </a></td>
                </tr>
                @php
                    $d++;
                @endphp
    ...
    <div class="alert alert-primary" role="alert">
        <h4 class="alert-heading">No Land Assets Found!</h4>
    </div>
    @endif
            ...
            <form class="col-md-8" action="{{route('assetsSummaryFiltered')}}" method="get">
              ...
              <div class="form-group  col">
                  <select id="my-select" class="form-control" name="date">
                      ...
                      @php
                          $dates = assetsassesland::select(DB::raw('DAY(assesmentYear) as day'))->distinct()->orderBy('assesmentyear','Desc')->get();
                      @endphp
                  ...
                  <select id="my-select" class="form-control" name="month">
                      ...
                      @php
                          $dates = assetsassesland::select(DB::raw('MONTH(assesmentYear) as month'))->distinct()->orderBy('assesmentyear','Desc')->get();
                      @endphp
                      @foreach ($dates as $dated)
                  ...
                  <select  id="my-select" class="form-control" name="year">
                      ...
                      @php
                          $dates = assetsassesland::select(DB::raw('YEAR(assesmentYear) as year'))->distinct()->orderBy('assesmentyear','Desc')->get();
                      @endphp
                      @foreach ($dates as $dated)
              ...
              <input name="asset" type="text" value="Land" hidden>
              <div class="col">
              ...
              <tbody>
                  ...
                  <tr>
                      ...
                      @php
                          ...
                          $asseted = assetsassesland::orderBy('assesmentYear','Desc') ->where('assetID',$asses->assetID)->first();
