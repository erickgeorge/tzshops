...
<div class="container"><br>
    <div class="row container-fluid" >
        <div class="col-md-6">
            <h5 ><b style="text-transform: capitalize;">Furnitures Assets</b></h5>
        </div>
    </div>
    <hr class="container">
    <div class="container">
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-2 text-right">
                ...
                <a href='{{route('assessingroup')}}?asset=furniture' class="btn btn-primary" title="assess all furniture assets"> Assess </a>
            ...
            <form class="col-md-8" action="{{route('assetsSummaryFiltered')}}" method="get">
              ...
              <div class="form-group  col">
                  <select id="my-select" class="form-control" name="date">
                      ...
                      @php
                          $dates = assetsassesfurniture::select(DB::raw('DAY(assesmentYear) as day'))->distinct()->orderBy('assesmentyear','Desc')->get();
                      @endphp
                  ...
                  <select id="my-select" class="form-control" name="month">
                      ...
                      @php
                          $dates = assetsassesfurniture::select(DB::raw('MONTH(assesmentYear) as month'))->distinct()->orderBy('assesmentyear','Desc')->get();
                      @endphp
                      @foreach ($dates as $dated)
                  ...
                  <select  id="my-select" class="form-control" name="year">
                      ...
                      @php
                          $dates = assetsassesfurniture::select(DB::raw('YEAR(assesmentYear) as year'))->distinct()->orderBy('assesmentyear','Desc')->get();
                      @endphp
                      @foreach ($dates as $dated)
