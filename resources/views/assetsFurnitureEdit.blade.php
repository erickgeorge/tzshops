...
<div class="container"><br>
    <div class="row container-fluid" >
        <div class="col">
            <h5 style="padding-left: 90px;"><b style="text-transform: uppercase;">Edit Furniture Asset</b></h5>
        </div>
    </div>
    <hr class="container">
    <div class="container">
...
@foreach ($land as $item)
        <form action="{{route('assetsFurnitureEditSave')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="card">
                <div class="card-body">
                    <div class="card-text">
